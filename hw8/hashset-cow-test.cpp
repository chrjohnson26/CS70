/**
 * hashset-cow-test.cpp
 * CS 70 Provided Code -- don't add to this file, make a new one.
 *
 * Tests a hashset to ensure that it is properly generic and doesn't
...
// test of whether the hashset is self sufficient.)  In hashset-test.cpp
// it'll be okay to add other includes, like stringhash.hpp, but don't do
// that here.
#include "hashset.hpp"
...
// Here, we've defined it as a non-member function.
